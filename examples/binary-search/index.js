import { createModule, encodeModule, InstrType, NumType, ValueBlockType, ExternalKind } from 'wasup';
...
const binarySearchInstructions = [[InstrType.LocalGet, 2],
    [InstrType.LocalGet, 3],
    [InstrType.I32Add],
    [InstrType.I32Const, 2],
    [InstrType.I32DivU],
    [InstrType.LocalTee, 4],
